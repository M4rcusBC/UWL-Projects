...
\item Say $T$ is the set of all the world's turtles. Say $M(x)$ is the predicate \fbox{$x$ has $33$ feet}. What steps would we have to take to prove \fbox{There exists $h \in T [M(h)]$}?
